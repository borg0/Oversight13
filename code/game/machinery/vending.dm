...
/obj/machinery/vending/weaponsvendor
	name = "Weapons Vendor"
	desc = "A security equipment vendor."
	product_ads = "Crack capitalist skulls!;Beat some heads in!;Don't forget - harm is good!;Your weapons are right here.;Handcuffs!;Freeze, scumbag!;Don't tase me bro!;Tase them, bro.;Why not have a donut?"
	icon_state = "gunrack"
	...
	products = list(/obj/item/weapon/gun/projectile/police = 6,
					...
					/obj/item/weapon/gun/projectile/automatic/mini_uzi = 6,
					/obj/item/ammo_magazine/m45uzi = 15,
					/obj/item/weapon/pickaxe/policehammer = 2
					)
	contraband = list(/obj/item/clothing/glasses/sunglasses = 2,/obj/item/weapon/storage/box/donut = 2)
	req_log_access = access_armory
	has_logs = 1
