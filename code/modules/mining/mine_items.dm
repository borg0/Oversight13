...
/obj/item/weapon/pickaxe/policehammer
	name = "breaching tool"
	icon_state = "cophammer"
	item_state = "cophammer"
	digspeed = 60 //faster than drill, but cannot dig
	origin_tech = list(TECH_MATERIAL = 3, TECH_POWER = 2, TECH_ENGINEERING = 2)
	desc = "Cracks skulls with ease."
	drill_verb = "hammering"
	drill_sound = 'sound/items/wallhit.ogg'
	w_class = ITEMSIZE_LARGE
